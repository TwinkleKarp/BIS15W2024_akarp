...
```{r}
relig_income <- read_csv("data/relig_income.csv") #need to make sure to use 'read_csv' not a dot
relig_income
```

2. Why are these data untidy?  every singe variable isnt in its own column(which is needed to make a plot)
