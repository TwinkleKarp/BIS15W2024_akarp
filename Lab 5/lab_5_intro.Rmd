...
tidyverse is a library full of packages- one of those packages being dplyr. Then, seect and filter are part of dplyr

2. Describe how `select ()` can be used to transform data frames.  
Allows you to select columns/variables of interest

3. Describe how `filter ()` can be used to transform data frames. 
Used to filter out specific values/rows
