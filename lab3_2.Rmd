...
Can change scientists from a character to a factor. A factor is when you have repeated sets of a type; categories of characters
```{r}
hot_spring$scientist <- as.factor(hot_spring$scientist)
hot_spring$spring <- as.factor(hot_spring$spring)
```

```{r}
levels(hot_spring$scientist)
